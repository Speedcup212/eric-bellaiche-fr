-- Reprocessing the same source document may refresh fields extracted from that same document without creating false client-data conflicts.
      ...
      loop
        ...
        then
          ...
          loop
            ...
            v_same_source := coalesce(v_existing_item->>'source_document_id','') = p_document_id::text;
            ...
            loop
              ...
              if v_value_text is null then
                ...
                v_applied := v_applied + 1;
                    ...
                    and lower(regexp_replace(v_existing_text,'[[:space:]]','','g'))
