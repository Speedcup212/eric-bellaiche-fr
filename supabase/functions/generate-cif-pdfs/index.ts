...
const PDF_VERSION = '2026-MAITRE-PDF-2.5';
...
async function buildRecueil(snapshot: Json) {
  ...
  title(ctx, "RECUEIL D'INFORMATIONS PATRIMONIALES", `Date du recueil : ${frDate(snapshot.recueil_date)} - Date d'entrée en relation : ${frDate(dossier.date_entree_relation)}`);
