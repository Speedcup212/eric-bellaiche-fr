...
const objectiveOptions = [
  ['optimisation_fiscale', 'Optimiser sa fiscalité'], ['achat_immobilier', 'Financer un achat immobilier'],
  ['constitution_patrimoine', 'Se constituer un patrimoine'], ['epargne_precaution', 'Se constituer une épargne de précaution'],
  ['liquidites_court_terme', 'Placer des liquidités à court terme'], ['revenus_complementaires', 'Obtenir des revenus complémentaires'],
  ['optimisation_rendement', 'Optimiser la rentabilité de ses placements'], ['retraite', 'Préparer sa retraite'],
  ['aide_enfants', 'Aider ses enfants / proches'], ['protection_conjoint', 'Protéger le conjoint survivant'],
  ['protection_proches', 'Protéger ses proches'], ['transmission', 'Préparer la transmission de son patrimoine'],
  ['transmission_entreprise', 'Préparer la transmission de son entreprise'], ['autre', 'Autre objectif'],
] as const;
