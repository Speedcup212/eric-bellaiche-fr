  ...
  return <div>
    ...
    <WizardCard>
      ...
      <div className="space-y-10 px-6 py-9 sm:px-9 sm:py-12">
        ...
        {errorMessage && <div role="alert" className="rounded-2xl border border-amber-400/60 bg-amber-50 px-5 py-4 text-sm leading-6 text-amber-950 shadow-sm"><p className="font-semibold">À compléter avant de continuer</p><p className="mt-1">{errorMessage}</p></div>}
