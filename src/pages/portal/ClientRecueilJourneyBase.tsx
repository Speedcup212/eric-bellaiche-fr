    ...
    <WizardCard>
      ...
      <div className="space-y-10 px-6 py-9 sm:px-9 sm:py-12">
        ...
        {current.code === 'regulatory' && <div className="divide-y divide-slate-400/50 [&>*]:py-7 [&>*:first-child]:pt-0 [&>*:last-child]:pb-0">
          ...
          <BoolChoice label="Souhaitez-vous que vos placements prennent en compte des critères environnementaux, sociaux ou de gouvernance (ESG) ?" value={form.esg_opt_in} onChange={(v) => patchCurrent({ esg_opt_in: v })} yesLabel="Oui, je souhaite les préciser" help="Ces trois critères ESG permettent d’exprimer vos préférences de durabilité : environnement et climat, enjeux sociaux et droits humains, ainsi que gouvernance responsable. Répondez selon vos convictions, sans connaissance technique particulière." />
          <SecureNote>Si vous répondez Oui, un questionnaire simple sur vos préférences de durabilité sera proposé après le profil investisseur. Il précisera vos priorités et vos éventuelles exclusions. Ce choix ne modifie pas votre profil de risque.</SecureNote>
        </div>}
