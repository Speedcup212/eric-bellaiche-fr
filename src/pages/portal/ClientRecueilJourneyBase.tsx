  ...
  return <div>
    ...
    <WizardCard>
      ...
      <div className="space-y-10 px-6 py-9 sm:px-9 sm:py-12">
        {current.code === 'identity' && <><div className="mb-7 flex items-center justify-between gap-4 rounded-2xl border border-blue-400/30 bg-[#132644] px-5 py-4 shadow-sm">
          <div className="min-w-0">
