  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#081426] px-4 py-10">
      <div className="w-full max-w-md rounded-[28px] border border-white/10 bg-white p-7 shadow-2xl sm:p-8">
        ...
        <p className="mt-3 text-sm leading-6 text-[#52627A]">Pour protéger vos données personnelles et patrimoniales, une seconde vérification est nécessaire après votre mot de passe.</p>
        ...
        {qrCode && (
          <div className="mt-6 rounded-2xl border border-[#D9E5F5] bg-[#F8FBFF] p-4">
            ...
            <p className="mt-1 text-xs leading-5 text-[#64748B]">Si vous n’avez pas encore d’application d’authentification, vous pouvez installer gratuitement Google Authenticator ou Microsoft Authenticator sur votre téléphone.</p>
            <p className="mt-2 text-xs leading-5 text-[#64748B]">Scannez ensuite ce QR code avec l’application, puis saisissez le code à 6 chiffres généré.</p>
