...
function PublicDossierAccess() {
  ...
  return (
    <Link
      ...
      className="fixed right-4 top-[5.5rem] z-[100] rounded-lg border border-[#C5A059] bg-white/95 px-3 py-2 text-[10px] font-bold uppercase tracking-wide text-[#8A6D2F] shadow-md backdrop-blur transition hover:bg-[#F7F1E6] sm:right-4 sm:top-3 sm:px-4 sm:py-2 sm:text-xs xl:right-[145px]"
    >
      Mon dossier
    </Link>
  );
