...
let investorsBlock = investorRaw.slice(0, controlsStart) + investorRaw.slice(controlsEnd);
investorsBlock = investorsBlock.replace('({ investor, investorSections, issues, summary })', '({ investor, investorSections, summary })');
